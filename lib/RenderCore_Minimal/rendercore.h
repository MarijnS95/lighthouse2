...
public:
	...
	inline void SetMaterials( CoreMaterial* mat, const CoreMaterialEx* matEx, const int materialCount ) override {}
	...
	inline void SetSkyData( const float3* pixels, const uint width, const uint height ) override {}
	inline void SetInstance( const int instanceIdx, const int modelIdx, const mat4& transform = mat4::Identity() ) override {}
